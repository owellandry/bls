                    ...
                    <div className="desktop">
                        <div className="navDesk">
                            ...
                            <div className="menuPrevDesk">
                                <ul>
                                    <li className="line" id={isActive1 ? 'active' : 'inactive'} onClick={()=>{setIsActive1(true);setIsActive2(false);setIsActive3(false);setIsActive4(false)}}><a href="#">menu</a></li>
                                    <li className="line" id={isActive2 ? 'active' : 'inactive'} onClick={()=>{setIsActive1(false);setIsActive2(true);setIsActive3(false);setIsActive4(false)}}><a href="#">menu</a></li>
                                    <li className="line" id={isActive3 ? 'active' : 'inactive'} onClick={()=>{setIsActive1(false);setIsActive2(false);setIsActive3(true);setIsActive4(false)}}><a href="#">menu</a></li>
                                    <li className="line" id={isActive4 ? 'active' : 'inactive'} onClick={()=>{setIsActive1(false);setIsActive2(false);setIsActive3(false);setIsActive4(true)}}><a href="#">menu</a></li>
                                </ul>
                            </div>
                        </div>
